...
$FileName = 'Maintenance.Summary.' . date("Ymd") . '.xlsx';
...
$objPHPExcel->getProperties()->setTitle("Maintenance Summary");
$objPHPExcel->getProperties()->setSubject("Maintenance Summary");
$objPHPExcel->getProperties()->setDescription("Maintenance summary. Generated by Company");
...
$objPHPActiveSheet->setTitle("Maintenance Summary");
$objDrawing = new PHPExcel_Worksheet_Drawing();
$objDrawing->setName('Network logo');
$objDrawing->setDescription('Network logo');
$objDrawing->setPath('images/network.png');
...
$objPHPActiveSheet->setCellValue('A4', 'Maintenance Summary');
