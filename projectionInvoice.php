...
{
	if($TaskStatusses[$Task['task_status']]['projectable'] != 1)
		unset($Tasks[$TaskID]);
}
?>
<form method='POST' action='genProjectionInvoice.php'>
<input type='hidden' name='cid' value='<?php echo $ClientID; ?>'>
<div class='panel panel-default'>
	<div class='panel-heading'>Invoice</div>
	<div class='panel-body'>
		<table class='table table-bordered table-condensed'>
		<tr><th colspan='2'></th><th colspan='6'><input type='text' name='invname' id='invname' value='' class='form-control'></th></tr>
		<tr><th>Client</th><td colspan='4'><?php echo $Client['clientname']; ?></td><th>Inv #</th><td colspan='3'><?php echo $Client['client_short'] . sprintf("%03d", $NextInvNum); ?></td></tr>
